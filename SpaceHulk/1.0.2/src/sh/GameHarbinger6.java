...
{
    public final static String NAME = "Retribution";
    public final static String INTRO = "/maps/36.html";
    private boolean attachToxin_ = false;

    public GameHarbinger6()
        throws IOException
    {
        super("/maps/36.shmap");
        ...
        // TODO While carrying TOXIN cannot shoot, combat or operate doors
    }
    ...
    {
        if ((object == TileType.OBJECT_AIRPUMP1
            || object == TileType.OBJECT_AIRPUMP2
            || object == TileType.OBJECT_AIRPUMP3
            || object == TileType.OBJECT_AIRPUMP4)
            && p instanceof Marine)
        {
            Marine m = (Marine) p;
    ...
    {
        if (object == TileType.OBJECT_TOXIN)
            return m.useActionPoints(1);
        else
            return super.testDrop(m, object);
    }
    ...
    {
        return false;   // Cannot pass TOXIN
    }
