...
/**
 * A <code>PositionNotifierInputStream</code> is a {@link FilterInputStream}
 * that notifies a listener every time datas are read from the input stream,
 * passing to the listener the actual percentage of data read. This stream needs
 * to know the complete size of the stream in order to calculate the percentage.
 * 
...
public class PositionNotifierInputStream extends FilterInputStream {
    ...
    /**
     * Wrap the provided {@link InputStream} in order to notify listeners when
     * data are read from it. This constructor initializes the stream with the
     ...
     *            The total size of the stream.
     * @param listener
     *            A listener that will be associated to the stream.
     */
     ...
     *            The minimum size of data read before events are propagated to
     *            listeners.
     */
    ...
    /**
     * Adds a {@link InputStreamDataReadListener} to the listeners list.
     * 
     * @param listener
    ...
    /**
     * Returns the minimum size of data that must be read before events are
     * propagated to listeners.
     * 
     * @return The minimum size of data that must be read before events are
     *         propagated to listeners.
     */
    ...
    /**
     * Returns a {@List} with all the listeners associated with this
     * stream.
     * 
