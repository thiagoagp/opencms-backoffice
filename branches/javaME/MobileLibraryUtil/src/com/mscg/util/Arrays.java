...
public class Arrays {
	...
	/**
	 * Sorts the specified array of integers according to the order induced by
	...
	public static void sort(int[] a, Comparator c) {
		Integer src[] = new Integer[a.length];
		for (int i = 0; i < a.length; i++) {
			src[i] = new Integer(a[i]);
		}
		sort(src, c);
	...
	/**
	 * Sorts the specified array of {@link Comparable} objects according to
	 ...
	 * 
	 * <pre>
	 * List&lt;String&gt; stooges = Arrays.asList(new Object[] { &quot;Larry&quot;, &quot;Moe&quot;, &quot;Curly&quot; });
	 * </pre>
	 * 
	 * @param a
	...
	// }
	//
	// private static void deepToString(Object[] a, StringBuffer buf,
	// Set<Object[]> dejaVu) {
	// if (a == null) {
	// buf.append("null");
	// return;
