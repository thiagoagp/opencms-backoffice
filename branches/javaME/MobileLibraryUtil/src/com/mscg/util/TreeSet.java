...
public class TreeSet extends AbstractSet implements NavigableSet {
	 ...
	 * e1} and {@code e2} in the set. If the user attempts to add an element to
	 * the set that violates this constraint, the {@code add} call will throw a
	 * {@code ClassCastException}.
	 * 
	 * @param comparator
	 *            the comparator that will be used to order this set. If {@code
	 *            null}, the {@linkplain Comparable natural ordering} of the
